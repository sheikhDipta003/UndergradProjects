...
export const PlaceGallary = ({place}) => {
  const [showAllPhotos,setShowAllPhotos] = useState(false);

  if (showAllPhotos) {
    return (
      <article className="absolute inset-0 bg-black text-white min-h-screen">
        <section className="bg-black p-8 grid gap-4">
          <div>
  ...
  return (
    <article className="relative">
      <section className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
        <div>
          {place.photos?.[0] && (
            <div>
