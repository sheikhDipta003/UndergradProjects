<article class="profile-status-write">
    <section class="status-wrap">
        <section class="status-top-wrap">
            <div class="status-top">
                Create Post
            </div>
        </section>

        <section class="status-med">
        ...
        <ul id="sortable" style="position:relative;"></ul>

        <section id="error_multiple_files"></section>

        <section class="status-share-button-wrap">
            <div class="status-share-button">
                <article class="newsFeed-privacy">
                    <div class="newsFeed">
            ...
            <div class="seemore-sharebutton">
                <div class="share-seemore-option">
                    <article class="privacy-downarrow-icon align-middle">
                        <img src="assets/image/watchmore.png" alt="">
