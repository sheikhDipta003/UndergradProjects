                ...
                <a href="<?php echo BASE_URL . $follower->userLink; ?>">
                    <article class="friend-img-name align-middle">
                        <span class="friend-img">
                            <img src="<?php echo $follower->profilePic; ?>" style="height:100px; width:100px;border:0.5px solid gray;" alt="">
                        </span>
                        <span class="friend-name"><?php echo '' . $follower->firstName . ' ' . $follower->lastName . ''; ?></span>
                    </article>
                </a>
