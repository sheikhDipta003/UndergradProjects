...
function renderSearchResult($searchResults, $user_id, $isMsgUser = false)
{
    ...
    if (empty($searchResults)) {
        echo '<li class="mention-individuals align-middle" style="font-size: 12px; padding:3px; margin-bottom:5px;" >No user found</li>';
    } else if (count($searchResults) == 1 && $searchResults[0]->userId == $user_id) {
