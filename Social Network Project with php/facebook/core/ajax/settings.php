...
if (isset($_POST['changeName'])) {
    ...
    echo '<h3 style="color:#4caf50;">Name has been changed successfully.</h3>';
}
...
if (isset($_POST['userLink'])) {
    ...
    if ($error == '') {
        echo '<h3 style="color:#4caf50;">User Link has been changed successfully.</h3>';
    } else {
        echo $error;
    }
}
...
if (isset($_POST['mobileChange'])) {
    ...
    if ($error == '') {
        echo '<h3 style="color:#4caf50;">Mobile number has changed successfully.</h3>';
    } else {
        echo $error;
    }
}
...
if (isset($_POST['emailChange'])) {
    ...
    if ($error == '') {
        echo '<h3 style="color:#4caf50;">Email has changed successfully.</h3>';
    } else {
        echo $error;
    }
}
...
if (isset($_POST['oldPassword'])) {
    ...
    if ($error == '') {
        echo '<h3 style="color:#4caf50;">Password has changed successfully.</h3>';
    } else {
        echo $error;
    }
}
